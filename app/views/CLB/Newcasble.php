...
<nav class="navbar navbar-expand-lg" style="background-color: #B22222;">
    ...
    <div class="header">
        <img src="../../../public/img/logo-CLB/New.png" alt="Newwcastle United Logo">
        ...
        <p>
            ...
            <a href="https://www.facebook.com/newcastleunited"><img src="../../../public/img/img-logo/face.png" alt="Facebook" width="20"></a>
            <a href="https://x.com/NUFC"><img src="../../../public/img/img-logo/X.png" alt="X (Twitter)" width="20"></a>
            <a href="https://www.youtube.com/channel/UCywGl_BPp9QhD0uAcP2HsJw"><img src="../../../public/img/img-logo/Youtube.png" alt="YouTube" width="20"></a>
            <a href="https://www.instagram.com/nufc/"><img src="../../../public/img/img-logo/ins.png" alt="Instagram" width="20"></a>
        </p>
    </div>
    <div class="content">
        <center><img src="../../../public/img/img-stadium/New.png" alt="St James Park"></center>
        <center>
            <h1>Chào mừng đến với Sân Vận Động St James Park</h1>
        </center>
        <?php
